...
<svg id="fill_heart" style="display: none;" board_no = "${board.bno}" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512">
...
<svg id ="empty_heart" style="display: block;" board_no="${board.bno}" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512">
...
<script>
    ...
    $(".update_comment").on("click", function () { //수정후, 새로고침
       location.reload();
    });
